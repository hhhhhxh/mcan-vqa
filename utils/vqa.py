...
class VQA:
	def __init__(self, annotation_file=None, question_file=None):
		...
		self.qqa = {}
		self.imgToQA = {}
		if annotation_file is not None and question_file is not None:	# if not annotation_file == None and not question_file == None:
			...
			self.createIndex()
			print('========== loading finished! (t=%0.2fs)' % ((datetime.datetime.utcnow() - time_t).total_seconds()))
	...
	def loadRes(self, resFile, quesFile):
		...
		"""
		res = VQA()	# load VQA annotations and questions into memory
